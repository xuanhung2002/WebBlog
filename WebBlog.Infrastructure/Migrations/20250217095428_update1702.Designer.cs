...
namespace WebBlog.Infrastructure.Migrations
{
    ...
    [Migration("20250217095428_update1702")]
    partial class update1702
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebBlog.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebBlog.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<Guid?>("ParentCommendId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebBlog.Domain.Entities.CommentReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CommentId")
                        .HasDatabaseName("Index_CommentReaction_CommentId");
            ...
            modelBuilder.Entity("WebBlog.Domain.Entities.PostReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PostId")
                        .HasDatabaseName("Index_PostReaction_PostId");
            ...
            modelBuilder.Entity("WebBlog.Domain.Entities.SubCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebBlog.Domain.Entities.CommentReaction", b =>
                {
                    b.HasOne("WebBlog.Domain.Entities.Comment", null)
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("WebBlog.Domain.Entities.Post", b =>
                {
                    b.HasOne("WebBlog.Domain.Entities.SubCategory", null)
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("WebBlog.Domain.Entities.SubCategory", b =>
                {
                    b.HasOne("WebBlog.Domain.Entities.Category", null)
